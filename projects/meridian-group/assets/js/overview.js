/*
	MZ Omar — overview.js
	Project-overview variant of main.js: same engine, real project data + a "View Project" link.
...
(function () {
	...
	/* ---------- Tab nav scroll spy (Overview tab only — project tabs track the active project instead) ---------- */
	...
	/* Project tabs in the header: reflect + drive the active project */
	...
	/* ---------- Projects data (real, completed work) ---------- */
	var divisions = [
		{
			name: 'Dashboard',
			tag: 'Excel · Data Viz',
			desc: 'An Excel dashboard built from raw orders, products and customer data — surfacing top countries and top customers at a glance.',
			link: 'https://github.com/MohammedZubairOmar/PortfolioProjects/blob/main/coffeeOrdersProject.xlsx',
			scene: 'wave'
		},
		{
			name: 'SQL',
			tag: 'SQL · Data Quality',
			desc: 'Raw Nashville housing data transformed in SQL into a clean, analysis-ready dataset.',
			link: 'https://github.com/MohammedZubairOmar/PortfolioProjects/blob/main/Nashville%20Housing%20-%20Data%20Cleaning.sql',
			scene: 'network'
		},
		{
			name: 'Currency',
			tag: 'Python · API',
			desc: 'A Python tool that calls a live currency API to convert between currencies on demand.',
			link: 'https://github.com/MohammedZubairOmar/PortfolioProjects/blob/main/Currency.py',
			scene: 'pipeline'
		},
		{
			name: 'BRD',
			tag: 'Business Analysis',
			desc: 'A Business Requirements Document scoping a coffee shop order-management enhancement, from data-quality gaps through functional requirements and success metrics.',
			link: 'https://github.com/MohammedZubairOmar/PortfolioProjects/blob/main/BRD%20-%20Coffee%20Shop%20Order%20Management%20Enhancement.md',
			scene: 'rings'
		}
	];
	...
	var divisionLinkEl = document.getElementById('division-link');
	...
	function setActiveDivision(i) {
		...
		if (divisionLinkEl) divisionLinkEl.href = d.link;
	...
	if (divisionLinkEl) divisionLinkEl.href = divisions[0].link;
